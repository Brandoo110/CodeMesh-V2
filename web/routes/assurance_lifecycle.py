...
_REMEDIATION_NOT_APPLIED_REASON_CODES = {
    ...
    "agent_error:RemediationAgentConfigurationBudgetError": "AGENT_CONFIGURATION_BUDGET_ERROR",
    ...
    "agent_error:RemediationAgentIterationBudgetError": "AGENT_ITERATION_BUDGET_ERROR",
    ...
    "agent_error:RemediationAgentRepeatedActionError": "REPEATED_ACTION_ERROR",
